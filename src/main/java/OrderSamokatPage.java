    ...
    import src.main.java.BaseWebDriver;
    ...
    //Когда привезти самокат:
        public void setDelivery() {
            ...
            String todayPlus2 = LocalDate.now().plusDays(2).format(formatter); // получаем текущую дату, прибавляем к ней 2 дня и форматируем
            WebElement pickCalendar = driver.findElement(INPUT_DELIVERY);
            pickCalendar.click();
            pickCalendar.sendKeys(todayPlus2);
            pickCalendar.sendKeys(Keys.ENTER);;
        }
